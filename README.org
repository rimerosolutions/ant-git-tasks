...
The =pom.xml= file at the root of this project is meant to illustrate Maven integration:

- Apache AntUnit integration tests are run as part of the project source code.
